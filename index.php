...
<html>
<head>
<title>MEDTECH MIND LAB| Home Page</title>
...
<body>
	<div class="header" id="home">
		<div class="header-top">
			<div class="container">
			   <div class="logo">
				  <a href="index.php">MTM LAB<span>lab</span></a>
				</div>
				<div class="top-menu">
...
<div class="contact_us" id="contactus">
		<div class="container">
			<h2>Contact Us @ 829663447 </h2>
			<h3>Email id : sumanthraj@gmail.com</h3>
			<script type="text/javascript" src="js/jquery.hoverdir.js"></script>
		<script type="text/javascript">
			$(function() {
